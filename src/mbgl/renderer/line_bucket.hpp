...
public:
    ...
    void drawLines(LineShader&, gl::ObjectStore&, gl::Config&, bool overdraw);
    void drawLineSDF(LineSDFShader&, gl::ObjectStore&, gl::Config&, bool overdraw);
    void drawLinePatterns(LinepatternShader&, gl::ObjectStore&, gl::Config&, bool overdraw);
